...
export class EndGame extends Phaser.Scene {
  ...
  create() {
    ...
    if (globalState.vidas === globalState.data.length) {
      htmlImagen.innerHTML = `<img src="./assets/images/frogQuiz/images/copaTrofeo.png" alt="Una copa de color amarillo" style="width: 300px; height: auto;">`;
    } else {
      htmlImagen.innerHTML = `<img src="./assets/images/frogQuiz/images/sapoLLorando.png" alt="una rana llorando" style="width: 300px; height: auto;">`;
    }
